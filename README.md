...
## Open Source Reason
I open sourced this program to help build the scrub file lists. The ruby code is a basic implementation, but the scrub lists can be used in any language.
